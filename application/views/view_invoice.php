    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="invoice-title">
                <h2>Invoice</h2>
                <h3 class="pull-right">
                    Invoice No # <?php if(!isset($res['dir_name'])){echo "On-";} echo $res['Invoice_Id']; ?>
                </h3>
            </div>
            <hr>
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <strong>Billed To:</strong><br>
                        <?php echo $res['s_fname']." ".$res['s_lname']; ?><br>
                        <?php echo $res['s_address']; ?><br>
                        <?php echo $res['s_city']; ?><br>
                    </address>
                </div>
